...
@section ('contenido')
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<h3>Editar Entrenador: {{ $persona->nombre}}</h3>
			@if (count($errors)>0)
			...
			{!!Form::model($persona,['method'=>'PATCH','route'=>['salidas.entrenador.update',$persona->idpersona]])!!}
            {{Form::token()}}
						...
						<div class="row">
							...
							<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
								...
								<label for="num_documento">Número Documento</label>
								 <input type="number" name="num_documento"  value="{{$persona->num_documento}}" class="form-control">
							</div>
							</div>
							...
							<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
								...
								<label for="telefono">Teléfono</label>
								 <input type="number" name="telefono" value="{{$persona->telefono}}" class="form-control">
							</div>
						</div>
