		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            ...
            {{Form::token()}}
						...
						<div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
								...
								<div class="col-md-12">
										<input id="password" type="password" class="form-control" name="password" placeholder="ingrese password...">
						...
						<div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
								...
								<div class="col-md-12">
										<input id="password-confirm" type="password" class="form-control" name="password_confirmation" placeholder="confirme password...">
